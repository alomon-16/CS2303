...
class Graph:
    ...
    def insert_edge(self,source,dest,weight=1):
        ...
        of direction and weight properties.
        """
    ...
    def draw(self):
        """
        Show the actual graph created, including its vertices, edges, and edge
    ...
    def in_degrees(self):
        """
        Return a list of length |V| that contains the in-degrees of the
        vertices of the graph represented as an adjacency list.
        """
        list_in_degrees = [0 for i in range(len(self.al))]
        for i in range(len(self.al)):
            for edge in self.al[i]:
                list_in_degrees[edge.dest] += 1
